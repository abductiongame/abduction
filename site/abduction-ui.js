(function () {
  ...
  const GITHUB_URL = 'https://github.com/abductiongame/abduction';
  ...
  ui.innerHTML = `
    <nav id="ab-bottom-bar" aria-label="Abduction links">
      <a id="ab-github" href="${GITHUB_URL}" target="_blank" rel="noopener noreferrer" aria-label="View Abduction on GitHub">
